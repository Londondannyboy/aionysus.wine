...
export const WINE_ENRICHMENTS: Record<string, WineEnrichment> = {
  'boal-borges-1875': {
    ...
    producerProfile: {
      ...
      image: 'https://images.unsplash.com/photo-1566995541428-f2246c17cda1?w=1200&q=80',
  ...
  '2011-ch-petrus-pomerol': {
    ...
    contextSection: {
      title: 'Why Petrus Red Wine Commands Legendary Status',
      content: 'The rise of Petrus Red Wine to the pinnacle of the wine world is one of the great stories in oenology. In the 1940s, Madame Loubat — the estate\'s formidable owner — introduced Petrus Red Wine to fashionable Parisian society and, crucially, to the American market. When Petrus Red Wine was served at a White House dinner for the Kennedys in the 1960s, its international reputation was sealed. Today, Petrus Red Wine is the benchmark for Merlot worldwide, and its unique blue clay terroir — a geological anomaly dating to the Cretaceous era — is recognised as one of the most extraordinary vineyard sites on earth. What makes Petrus Red Wine truly remarkable is the consistency of quality across vintages: even in challenging years like 2011, the estate produces wines of extraordinary refinement.',
    },
    ...
    collectorsNotes: 'Petrus Red Wine 2011 represents exceptional value within the Pétrus portfolio. While the blockbuster 2009 and 2010 command extraordinary premiums, this Petrus Red Wine offers genuine terroir expression at a significant discount. For collectors, the 2011 Petrus Red Wine is an accessible entry point to one of the world\'s most legendary wines. Ensure all purchases of Petrus Red Wine come from reputable sources with complete provenance documentation. Château Pétrus wines are among the most counterfeited in the world — authentication services are recommended for secondary market purchases.',
    externalLinks: [
      { name: 'Établissements Jean-Pierre Moueix', url: 'https://www.moueix.com', description: 'Official Pétrus owner and négociant' },
      { name: 'Wikipedia: Pétrus', url: 'https://en.wikipedia.org/wiki/P%C3%A9trus_(wine)', description: 'History and classification of Château Pétrus' },
      { name: 'Wikipedia: Pomerol', url: 'https://en.wikipedia.org/wiki/Pomerol', description: 'The Pomerol appellation and its unique terroir' },
      { name: 'Wikipedia: Merlot', url: 'https://en.wikipedia.org/wiki/Merlot', description: 'The noble grape variety behind Pétrus' },
      ...
      { name: 'Jancis Robinson: Pétrus', url: 'https://www.jancisrobinson.com/articles/petrus', description: 'Master of Wine tasting notes and analysis' },
      { name: 'Decanter: Pomerol Guide', url: 'https://www.decanter.com/wine/wine-regions/bordeaux/pomerol/', description: 'Award-winning wine magazine coverage' },
      { name: 'Liv-ex Fine Wine Exchange', url: 'https://www.liv-ex.com', description: 'Secondary market trading platform for fine wine' },
      { name: 'Wine-Searcher: Pétrus 2011', url: 'https://www.wine-searcher.com/find/petrus+pomerol+2011', description: 'Current market prices and merchant listings' },
      { name: 'Robert Parker Wine Advocate', url: 'https://www.robertparker.com', description: 'The critic who defined Pétrus for modern collectors' },
      { name: 'Berry Bros & Rudd: Pétrus', url: 'https://www.bbr.com/producer-petrus', description: 'Historic London merchant with Pétrus allocation' },
    ],
    seo: {
      title: 'Petrus Red Wine 2011 - Château Pétrus Pomerol | Buy Online | Aionysus',
      h1: '2011 Petrus Red Wine — Château Pétrus, Pomerol',
      metaDescription: 'Petrus Red Wine 2011 from Château Pétrus, Pomerol. Buy this legendary Bordeaux Merlot — scored 94-96 points. Expert tasting notes, investment analysis, food pairings for Petrus Red Wine.',
      imageAlt: 'Petrus Red Wine 2011 bottle - Château Pétrus Pomerol Bordeaux',
      bodyKeyword: 'Petrus Red Wine',
    },
    regionImages: {
      hero: 'https://images.unsplash.com/photo-1507434965515-61970f2bd7c6?w=1920&q=80&fit=crop',
      mid: 'https://images.unsplash.com/photo-1560493676-04071c5f467b?w=1920&q=80&fit=crop',
      footer: 'https://images.unsplash.com/photo-1543418219-6b3623a55c9d?w=1920&q=80&fit=crop',
    },
    regionTravel: {
      title: 'Discover Pomerol: Home of Petrus Red Wine',
      intro: 'Pomerol is Bordeaux\'s most intimate and exclusive appellation — a tiny plateau of extraordinary terroir producing some of the world\'s most expensive wines. At its heart sits Château Pétrus, whose unique blue clay soil produces Petrus Red Wine of unmatched purity and complexity. Unlike the grand châteaux of the Médoc, Pomerol\'s estates are modest in size but monumental in quality. Visiting this hallowed ground is a pilgrimage for any serious wine lover.',
      highlights: [
  ...
  '2009-ch-petrus-pomerol': {
    ...
    externalLinks: [
      ...
      { name: 'Wikipedia: Pétrus', url: 'https://en.wikipedia.org/wiki/P%C3%A9trus_(wine)', description: 'History and classification of Château Pétrus' },
      { name: 'Wikipedia: Pomerol', url: 'https://en.wikipedia.org/wiki/Pomerol', description: 'The Pomerol appellation and its unique terroir' },
      { name: 'Wikipedia: 2009 Bordeaux Vintage', url: 'https://en.wikipedia.org/wiki/2009_Bordeaux_en_primeur', description: 'The legendary 2009 vintage in Bordeaux' },
      { name: 'Bordeaux Wine Council: Pomerol', url: 'https://www.bordeaux.com/en/Our-Terroir/Appellations/Pomerol', description: 'Official Pomerol appellation information' },
      { name: 'Wine Advocate (Robert Parker)', url: 'https://www.robertparker.com', description: 'The 100-point perfect score for this wine' },
      { name: 'Jancis Robinson: Pétrus', url: 'https://www.jancisrobinson.com/articles/petrus', description: 'Master of Wine tasting notes and analysis' },
      { name: 'Decanter: Best 2009 Bordeaux', url: 'https://www.decanter.com/wine/wine-regions/bordeaux/', description: 'Expert analysis of the 2009 vintage' },
      { name: 'Wine Spectator: Pétrus', url: 'https://www.winespectator.com/articles/petrus-pomerol', description: 'Expert reviews and vintage ratings' },
      { name: 'Liv-ex Fine Wine Exchange', url: 'https://www.liv-ex.com', description: 'Secondary market trading and price data' },
      { name: 'Wine-Searcher: Pétrus 2009', url: 'https://www.wine-searcher.com/find/petrus+pomerol+2009', description: 'Current market prices and merchant listings' },
      { name: 'Berry Bros & Rudd', url: 'https://www.bbr.com/producer-petrus', description: 'Britain\'s oldest wine merchant — Pétrus specialists' },
    ],
  },
  ...
  '2019-grands-echezeaux-grand-cru-nicole-lamarche': {
    ...
    externalLinks: [
      { name: 'Bourgogne Wines Official (BIVB)', url: 'https://www.bourgogne-wines.com', description: 'Official Burgundy wines information body' },
      { name: 'Domaine Lamarche', url: 'https://www.domaine-lamarche.com', description: 'Official producer website and vineyard map' },
      { name: 'Wikipedia: Grands Échézeaux', url: 'https://en.wikipedia.org/wiki/Grands_%C3%89ch%C3%A9zeaux', description: 'Grand Cru vineyard history and classification' },
      { name: 'Wikipedia: Vosne-Romanée', url: 'https://en.wikipedia.org/wiki/Vosne-Roman%C3%A9e', description: 'The commune and its legendary Grand Crus' },
      { name: 'Wikipedia: Pinot Noir', url: 'https://en.wikipedia.org/wiki/Pinot_noir', description: 'The noble grape of Burgundy' },
      { name: 'Climats de Bourgogne (UNESCO)', url: 'https://www.climats-bourgogne.com', description: 'UNESCO World Heritage vineyard classification' },
      { name: 'Burghound (Allen Meadows)', url: 'https://www.burghound.com', description: 'Burgundy specialist critic reviews' },
      { name: 'Jancis Robinson: Burgundy', url: 'https://www.jancisrobinson.com/learn/wine-regions/france/burgundy', description: 'Master of Wine expert Burgundy guide' },
      { name: 'Decanter: Burgundy Guide', url: 'https://www.decanter.com/wine/wine-regions/burgundy/', description: 'Award-winning wine magazine Burgundy coverage' },
      { name: 'Wine-Searcher: Grands Échézeaux', url: 'https://www.wine-searcher.com/find/grands+echezeaux', description: 'Current market prices and availability' },
      { name: 'Liv-ex: Burgundy Market', url: 'https://www.liv-ex.com', description: 'Fine wine exchange and Burgundy indices' },
      { name: 'Wine Spectator: Burgundy', url: 'https://www.winespectator.com/regions/burgundy', description: 'Expert reviews and vintage ratings' },
    ],
  },
}
